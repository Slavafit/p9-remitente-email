...
## Next Steps 🔜
 Imposibilidad de enviar invitaciones para eventos que están cerrados. La fecha y la hora ya han pasado. Tampoco es posible aceptar respuestas una vez iniciado el evento. Mayor seguridad con el uso de dos tokens, uno de los cuales debe actualizarse cada, por ejemplo, 30 minutos.
